    ...
    <div class="row">
      <div class="mx-auto col-lg-9 col-12">
        <div class="mt-4 card card-body">
          <h6 class="mb-0">New Room</h6>
          <p class="mb-0 text-sm">Create new room</p>
          <hr class="my-3 horizontal dark" />
          <label for="projectName" class="form-label">Room Name</label>
          ...
          <label class="mt-4">Room Description</label>
          <p class="text-xs form-text text-muted ms-1">
            This is a description for the users to read about the room, so make it good!
          </p>
          <div id="editor">
            <p>write room description here</p>
