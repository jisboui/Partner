...
export default {
  ...
  beforeMount() {
    this.initializeQuill("#edit-description-edit");
    this.initializeChoices("choices-category-edit", []);
    this.initializeChoices("choices-color-edit", []);
    this.initializeChoices("choices-currency-edit", []);
    this.initializeChoicesTags("choices-tags-edit");
  },
  ...
  methods: {
    ...
    initializeChoices(id, choicesData) {
      ...
      if (element) {
        ...
        this.setChoicesSafely(choices, choicesData);
      } else {
        console.error(`Element with ID '${id}' not found in the DOM.`);
      }
    },

    initializeChoicesTags(id) {
      const element = document.getElementById(id);
      if (element) {
        const choices = new Choices(element, {
    ...
    setChoicesSafely(choices, data) {
      if (choices) {
        choices.setChoices(data, "value", "label", false);
      } else {
        console.error("Choices instance is undefined.");
      }
    },
  },
};
