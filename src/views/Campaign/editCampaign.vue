          ...
          <div class="row">
            <div class="col-6">
              ...
              <select
                ...
                v-model="room.idGame"
              >
                <option :value="$route.params.game" selected disabled>{{$route.params.game}}</option>
            ...
            <div class="col-6">
              ...
              <select v-model="room.idProduct" id="product" class="form-control" name="choices-category" @change="updateSelectedGift">
                <option :value="$route.params.product" selected disabled>{{$route.params.product}}</option>
...
export default {
  ...
  data() {
    return {
     room : {
      "startingDate": this.$route.params.dateTime,
      "periodInDays": "7",
      "idProduct": this.$route.params.product,
      "idGame": this.$route.params.game,
      "details": {
        "woodad": [],
        "tvad": [],
        "carre": [],
  ...
  methods : {
    ...
    for (const prop in this.room.details) {
      ...
      console.log("id in campaign edition:", id);
      this.$store.dispatch("roomNS/updateroom", { id, roomPUT: this.room })
    },
  },
  mounted() {
