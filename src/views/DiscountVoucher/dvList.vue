      ...
      <div id="DV" class="container" style="display: flex; justify-content: center; align-items: center;">
        <div class="card">
          <div class="main">
            ...
            <br>
              <h1><input v-model="dvP.discountValue" type="text" class="editable-input"> <select class="editable-input"><option>Bon de réduction</option><option>Bon d'achat</option></select></h1>
      ...
      <div class="items-container" >
        <div class="item" v-for="dv in dvs.data" :key="dv.id" :value="dv.id">
          <div class="item-details" >
            <strong>{{ dv.discountValue }} réduction</strong> - {{ dv.validityInDays }} jours - {{ dv.dvType }}
          </div>
          <div class="item-actions">
            <button @click="editItem(dv.id)" class="edit-button">Modifier</button>
            <button @click="deleteItem(dv.id)" class="delete-button">Supprimer</button>
          </div>
        </div>
      </div>
