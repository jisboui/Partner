...
export default {
  ...
  methods: {
    showTooltip(event) {
      // Show a alerting message to the partner when hovering over the next button if the Partner hasn't uploaded an image yet
  ...
  watch: {
    uploadComplete(newVal) {
      // Destroy the alerting message when the image is uploaded by the Partner
